...
//    [self.view addSubview:self.scrollViewProxy];
    ...
    [self.view insertSubview:self.scrollViewProxy atIndex:0];
    [self.view addSubview:self.autoCompletionView];
    [self.view addSubview:self.typingIndicatorProxyView];
    [self.view addSubview:self.textInputbar];

    [self slk_setupViewConstraints];
    self.scrollViewProxy.contentInset = UIEdgeInsetsZero;
    self.scrollViewProxy.scrollIndicatorInsets = UIEdgeInsetsZero;
...
- (SLKTextInputbar *)textInputbar
{
    if (!_textInputbar) {
        ...
        [_textInputbar.emoticonButton addTarget:self action:@selector(didPressEmoticonButton:) forControlEvents:UIControlEventTouchUpInside];
...
- (UIButton *)emoticonButton {
    return _textInputbar.emoticonButton;
}
